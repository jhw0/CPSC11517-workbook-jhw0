...
namespace Hockey.Data
{
    ...
    public class HockeyPlayer
    {
        ...
        //constants
        private const int _MinJeryseyNumber = 1;
        private const int _MaxJeryseyNumber = 98;
        ...
        public int JerseyNumber
        {
            ...
            set
            {
                if (!Utilities.IsInRange(value, _MinJeryseyNumber, _MaxJeryseyNumber))
                {
                    throw new ArgumentException($"Jersey number must be between {_MinJeryseyNumber} and {_MaxJeryseyNumber}.");
                }
